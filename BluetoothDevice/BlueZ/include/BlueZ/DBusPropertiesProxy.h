#ifndef DEVICE_CLIENT_SDK_BLUETOOTHDEVICE_BLUEZ_DBUSPROPERTIESPROXY_H_
#define DEVICE_CLIENT_SDK_BLUETOOTHDEVICE_BLUEZ_DBUSPROPERTIESPROXY_H_
...
#endif // DEVICE_CLIENT_SDK_BLUETOOTHDEVICE_BLUEZ_DBUSPROPERTIESPROXY_H_
