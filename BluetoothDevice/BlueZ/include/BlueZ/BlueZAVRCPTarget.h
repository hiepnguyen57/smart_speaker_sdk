#ifndef DEVICE_CLIENT_SDK_BLUETOOTHDEVICE_BLUEZ_BLUEZAVRCPTARGET_H_
#define DEVICE_CLIENT_SDK_BLUETOOTHDEVICE_BLUEZ_BLUEZAVRCPTARGET_H_
...
#endif // DEVICE_CLIENT_SDK_BLUETOOTHDEVICE_BLUEZ_BLUEZAVRCPTARGET_H_
