#ifndef DEVICE_CLIENT_SDK_BLUETOOTH_BLUEZ_MPRISPLAYER_H_
#define DEVICE_CLIENT_SDK_BLUETOOTH_BLUEZ_MPRISPLAYER_H_
...
#endif // DEVICE_CLIENT_SDK_BLUETOOTH_BLUEZ_MPRISPLAYER_H_